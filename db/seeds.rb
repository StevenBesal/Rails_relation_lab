...
15.times do
  ...
  Author.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, age:Faker::Number.between(20, 50), country_id: rand(1..country))
end

20.times do
  author = Author.all.length
  Book.create(title: Faker::Book.title, genre: Faker::Book.genre, published:Faker::Date.backward(14), author_id: rand(1..author))
end
...
30.times do
  ...
  Paragraph.create(body: Faker::Lorem.sentences(3), chapter_id: rand(1..chapter))
end
